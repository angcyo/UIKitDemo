...
import com.angcyo.uikitex.chart.*
import com.angcyo.uiview.less.kotlin.toDp
 ...
 */
class MPChartDemo3 : AppBaseItemFragment() {
        ...
        singleItems.add(object : SingleItem() {
            ...
            override fun onBindView(holder: RBaseViewHolder, posInData: Int, itemDataBean: Item?) {
                (holder.itemView as? BarChart)?.apply {
                    //marker = MarkerImage(mAttachContext, R.drawable.ic_logo)
                    marker = MarkerText()
