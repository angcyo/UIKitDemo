...
class GuideFrameLayout(context: Context, attributeSet: AttributeSet? = null) : FrameLayout(context, attributeSet) {
    ...
    class LayoutParams : FrameLayout.LayoutParams {
        ...
        constructor(c: Context, attrs: AttributeSet?) : super(c, attrs) {
            ...
            offsetWidth =
                a.getDimensionPixelOffset(R.styleable.GuideFrameLayout_Layout_r_guide_offset_width, offsetWidth)
            offsetHeight =
                a.getDimensionPixelOffset(R.styleable.GuideFrameLayout_Layout_r_guide_offset_height, offsetHeight)
            isAnchor = a.getBoolean(R.styleable.GuideFrameLayout_Layout_r_guide_is_anchor, isAnchor)
            withAnchor = a.getBoolean(R.styleable.GuideFrameLayout_Layout_r_guide_with_anchor, withAnchor)
            a.recycle()
        }
